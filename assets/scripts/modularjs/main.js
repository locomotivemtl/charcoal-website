export default class {
    ...
    init(app, scope, promiseResolve) {
          ...
          Array.from(el.attributes).forEach((i) => {
            ...
            if (i.name.startsWith('data-module')) {
                ...
                if (moduleExists) {
                    ...
                    promises.push((async () => {
                        const moduleInstance = await this.modules[moduleName];
                        promises.push(moduleInstance);

                        const module = new moduleInstance.default(options);
        ...
        // Waiting all current modules are dynamically import
    ...
    update(scope) {
        this.initPromise = new Promise((resolve, reject) => {
            this.init(this.app, scope, resolve);
        });
